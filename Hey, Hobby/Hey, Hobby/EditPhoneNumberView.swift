...
@MainActor final class EditPhoneNumberViewModel: ObservableObject {
    ...
    func currentUser() async -> DBUser? {
        do {
            ...
            return DBUser(id: userData.id, firstName: userData.firstName, lastName: userData.lastName, phoneNumber: phoneNumber, emailAddress: userData.emailAddress, subscriptionNeeded: false)
        } catch {
